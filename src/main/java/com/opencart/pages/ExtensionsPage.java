 ...
 */
public class ExtensionsPage extends Browsers {
	...
	private String extensionsLink = "a[href=\"#collapse-2\"]";
	private String marketplaceLink = "#collapse-2 > li:nth-of-type(1) > a";
	 ...
	 */
	public ExtensionsPage(Page page) {
		this.page = page;
	}
